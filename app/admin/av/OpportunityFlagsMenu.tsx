  ...
  return (
    <div ref={wrapRef} className="relative inline-block">
      ...
      {open && (
        ...
        >
          <div className="px-4 py-3 border-b border-border bg-gradient-to-b from-[var(--gold-bright)]/[0.06] to-transparent flex items-baseline justify-between gap-2">
            <div>
...
function FlagRow({
  ...
  return (
    <li className="group hover:bg-[var(--gold-bright)]/[0.04] transition">
      <div className="flex items-start gap-2.5 px-4 py-2.5">
        ...
        <div className="min-w-0 flex-1">
          <Link
            href={href}
            onClick={onNavigate}
            className="text-[13px] text-ink font-medium leading-snug hover:text-[color-mix(in_srgb,var(--gold-bright)_95%,transparent)] transition block truncate"
          >
            {flag.company}
          </Link>

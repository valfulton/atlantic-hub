/**
 * /admin/av/products/collections-intelligence  (val 2026-06-11)
 *
 * OPERATOR-ONLY grouped landing page for the Collections Intelligence
 * vertical. Moved from public /products/collections-intelligence per
 * val 2026-06-11. Behind /admin/* JWT wall.
 *
 * Renders server-side from the static product registry at
 * lib/av/products.ts. Internal planning surface — not for sale yet.
 */
...
export const metadata = {
  title: 'Collections Intelligence (internal) · Atlantic & Vine'
};

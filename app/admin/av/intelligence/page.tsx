...
function chipCls(active: boolean): string {
  return active
    ? 'inline-flex items-center rounded-md border border-amber-400/40 bg-amber-400/10 px-2.5 py-1 text-amber-100'
    : 'inline-flex items-center rounded-md border border-border bg-surface px-2.5 py-1 text-ink hover:border-amber-400/40 hover:text-amber-100';
}
      ...
      <div className="flex items-baseline justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-2xl font-semibold text-white">
            Intelligence <span className="text-amber-300 italic">chain</span>
          </h1>
        ...
        footer={
          <div className="mt-4 border-t border-border pt-3">
            <div className="text-[10px] uppercase tracking-[0.14em] text-muted mb-2">
              ...
              <span className="ml-2 normal-case tracking-normal text-amber-300/70">lineage graph pending (#322)</span>
            </div>
              ...
              <ul className="space-y-1">
                {revenue.attribution.map((a) => (
                  <li key={a.narrativeLineId} className="flex items-center justify-between text-[12.5px]">
                    <Link href={`/admin/av/narrative`} className="text-ink hover:text-amber-100 truncate pr-3">{a.narrativeLine}</Link>
      ...
      <div className="grid md:grid-cols-[1.1fr_1fr] gap-0">
        <div className="p-6">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-[11px] tabular-nums text-amber-300/60">{step}</span>

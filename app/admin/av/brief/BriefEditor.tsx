          ...
          return (
            <button
              ...
              className={
                ...
                (on
                  ? 'bg-[color-mix(in_srgb,var(--gold-bright)_20%,transparent)] border-[color-mix(in_srgb,var(--gold-bright)_60%,transparent)] text-[color-mix(in_srgb,var(--gold-bright)_95%,transparent)]'

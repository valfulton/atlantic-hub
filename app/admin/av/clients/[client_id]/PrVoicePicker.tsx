...
export default function PrVoicePicker({
  ...
  function pillClass(active: boolean): string {
    return (
      ...
      (active
        ? 'bg-[color-mix(in_srgb,var(--gold-bright)_12%,transparent)] text-[color-mix(in_srgb,var(--gold-bright)_95%,transparent)] border-[color-mix(in_srgb,var(--gold-bright)_35%,transparent)]'
  ...
  return (
    <div className="rounded-2xl border border-border bg-surface p-4">
      ...
      <div className="mt-3 flex items-center gap-3 text-[10.5px]">
        {busy && <span className="text-[color-mix(in_srgb,var(--gold-bright)_70%,transparent)]">Saving…</span>}

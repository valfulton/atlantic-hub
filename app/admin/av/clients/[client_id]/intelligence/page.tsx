...
function ConsumerChips({ consumers, unused }: { consumers: string[]; unused: boolean }) {
  ...
  return (
    <span className="flex flex-wrap gap-1.5">
      {consumers.map((c) => (
        <span key={c} className="inline-flex items-center rounded-full bg-[color-mix(in_srgb,var(--gold-bright)_10%,transparent)] text-[color-mix(in_srgb,var(--gold-bright)_95%,transparent)] border border-[color-mix(in_srgb,var(--gold-bright)_30%,transparent)] px-2 py-0.5 text-[10px] uppercase tracking-[0.14em]">
          {c}
        </span>
      ))}
    </span>
        ...
        {inv.clientIndustries.length === 0 ? (
          ...
          <ul className="space-y-3">
            {inv.prDiscoveryObjects.map((o) => (
              <li key={o.id} className="rounded-2xl border border-[color-mix(in_srgb,var(--gold-bright)_20%,transparent)] bg-[var(--gold-bright)]/[0.04] p-4">
                <div className="flex items-start justify-between gap-4 mb-2 flex-wrap">
                  <div>
                    <div className="text-[10px] uppercase tracking-[0.22em] text-[var(--gold-bright)]">{o.object_type}</div>
                    <div className="text-[11px] text-muted mt-0.5">
                  ...
                  <span className="inline-flex items-center rounded-full bg-[color-mix(in_srgb,var(--gold-bright)_12%,transparent)] text-[color-mix(in_srgb,var(--gold-bright)_95%,transparent)] border border-[color-mix(in_srgb,var(--gold-bright)_30%,transparent)] px-2 py-0.5 text-[10px] uppercase tracking-[0.14em]">
                    PR engine
                  </span>
                </div>

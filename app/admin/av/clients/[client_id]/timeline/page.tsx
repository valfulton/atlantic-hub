...
const KIND_STYLE: Record<TimelineKind, { dot: string; chip: string }> = {
  ai_call:   { dot: 'bg-[var(--gold-bright)]',  chip: 'border-[color-mix(in_srgb,var(--gold-bright)_40%,transparent)] text-[var(--gold-bright)] bg-[color-mix(in_srgb,var(--gold-bright)_10%,transparent)]' },
...
const STATUS_STYLE: Record<TimelineItem['status'], string> = {
  ...
  partial: 'text-[color-mix(in_srgb,var(--gold-bright)_90%,transparent)]',
